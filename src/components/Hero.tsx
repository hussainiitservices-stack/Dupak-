  ...
  return (
    <section className="relative min-h-[92vh] overflow-hidden pt-16">
      <AnimatePresence mode="wait">
        ...
        >
          {/* Large product watermark banner */}
          <div className="absolute inset-0 flex items-center justify-end overflow-hidden pr-0 lg:pr-[5%]">
            <motion.div
              initial={{ scale: 0.85, opacity: 0.15 }}
              animate={{ scale: 1, opacity: 0.22 }}
              transition={{ duration: 1.2 }}
              className="relative h-[70vh] w-[70vh] max-w-none"
            >
              <Image
                src={slide.image}
                alt=""
                fill
                className="object-contain animate-ken-burns blur-[2px]"
                sizes="70vh"
                aria-hidden
              />
            </motion.div>
        ...
        <div className="grid w-full items-center gap-10 lg:grid-cols-2">
          ...
          >
            <motion.div
              ...
              style={{ transformStyle: "preserve-3d" }}
            >
              <div className="absolute -inset-4 rounded-full bg-white/60 shadow-2xl shadow-rose-100/80 backdrop-blur-sm" />
              <Image
                src={slide.image}
                alt={slide.title}
                fill
