...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="whatsapp-pop fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-200 transition-transform hover:scale-110 active:scale-95"
    >
